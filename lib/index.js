...
const script = () => {
    return src(config.build.paths.styles, { base: config.build.src, cwd: config.build.src }) // 读取流 , base 基准路径，保留 src/assets/scripts/*.js 目录结构，第二个参数 cwd 是从哪个地方开始找，从当前项目下的 src
